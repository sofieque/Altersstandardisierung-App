...
Wie hier zu erkennen ist, ist die Altersstruktur von bspw. Taiwan sehr "jung" (nur `r above60_TW`% sind älter als 60 Jahre), während die der EU im Vergleich eine "alte" Altersstruktur aufweist (hier sind `r above60_EU`% älter als 60 Jahre).
